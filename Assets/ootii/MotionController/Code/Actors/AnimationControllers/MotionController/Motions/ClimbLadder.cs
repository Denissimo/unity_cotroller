...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class ClimbLadder : MotionControllerMotion
    {
        ...
        public ClimbLadder()
            : base()
        {
            _Category = EnumMotionCategories.CLIMB_LADDER;
        ...
        public virtual bool TestForClimbInAir()
        {
            ...
            lRayStart = mActorController._Transform.position + (mActorController._Transform.up * mActorController.Height);
            if (!RaycastExt.SafeRaycast(lRayStart, lRayDirection, lRayDistance, _ClimbableLayers, mActorController._Transform))
            {
                return false;
            }
