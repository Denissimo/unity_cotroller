                    ...
                    if (lItem.StoreMotion.Length > 0)
                    {
                        ...
                        if (lMotion != null)
                        {
                            ...
                            while (lMotion.IsActive || lMotion.QueueActivation)
                            {
                                ...
                                if (!lStanceSet && rClearStates && lMotion.Age > 0.3f)
                                {
                                    lStanceSet = true;
                                    mMotionController.Stance = 0; 
                                    mMotionController.DefaultForm = 0; 
                                }
                            }
                        }
                    }
                    ...
                    if (lSlot != null && lSlot.ItemID.Length == 0)
                    {
                        ...
                        if (lMotion != null)
                        {
                            ...
                            while (lMotion.IsActive || lMotion.QueueActivation)
                            {
                                ...
                                // Set the stance so when we come out of the motion, we go to the right idle
                                if (!lStanceSet && lMotion.Age > 0.3f)
                                {
                                    lStanceSet = true;
                                    if (WeaponSets[rIndex].Stance > 0) { mMotionController.Stance = WeaponSets[rIndex].Stance; }
                                    if (WeaponSets[rIndex].DefaultForm > 0) { mMotionController.DefaultForm = WeaponSets[rIndex].DefaultForm; }
                                }
                            }
                        ...
                        if (lMotion != null)
                        {
                            ...
                            while (lMotion.IsActive || lMotion.QueueActivation)
                            {
                                ...
                                if (!lStanceSet && lMotion.Age > 0.3f)
                                {
                                    ...
                                    if (WeaponSets[rIndex].DefaultForm >= 0) { mMotionController.DefaultForm = 0; }
                                }
                            }
