...
namespace com.ootii.Geometry
{
    ...
    public static class RaycastExt
    {
        ...
        // ***********************************************************************************
        // Older allocating versions of the call. All these calls are obsolete
        // ***********************************************************************************
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static bool SafeRaycastX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, int rLayerMask, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <returns></returns>
        public static bool SafeRaycastX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, Transform rIgnore)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rIgnore">List of transforms we should ignore collisions with</param>
        /// <returns></returns>
        public static bool SafeRaycastX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, Transform rIgnore, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// Note: This function isn't virutal to eek out ever ounce of performance we can.
        /// </summary>
        /// <param name="rRayStart">Start position of the ray to shoot</param>
        /// <param name="rRayDirection">Direction to shoot the ray</param>
        /// <param name="rDistance">Distance to shoot the ray</param>
        /// <param name="rLayerMask">Layer mask that defines what we'll collide with</param>
        /// <param name="rIgnore">Transform we should ignore collisions with</param>
        /// <param name="rIgnoreTriggers">Determines if we'll ignore triggers or collide with them</param>
        /// <returns></returns>
        public static bool SafeRaycastX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, int rLayerMask, Transform rIgnore, out RaycastHit rHitInfo, bool rIgnoreTriggers = true)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rIgnore">List of transforms we should ignore collisions with</param>
        /// <returns></returns>
        public static bool SafeRaycastX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, List<Transform> rIgnore, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
            Vector3 lRayStart = rRayStart;
        ...
        /// <param name="rIgnore">List of transforms we should ignore collisions with</param>
        /// <returns></returns>
        public static bool SafeRaycastRefX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, List<Transform> rIgnore, ref RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
            Vector3 lRayStart = rRayStart;
        ...
        /// <param name="rIgnore">List of transforms we should ignore collisions with</param>
        /// <returns></returns>
        public static bool SafeRaycastX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, int rLayerMask, List<Transform> rIgnore, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rIgnore">List of transforms we should ignore collisions with</param>
        /// <returns></returns>
        public static bool SafeRaycastRefX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, int rLayerMask, List<Transform> rIgnore, ref RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static RaycastHit[] SafeRaycastAllX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance)
        {
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static RaycastHit[] SafeRaycastAllX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, bool rRemoveTriggers)
        {
            RaycastHit[] lHitArray = UnityEngine.Physics.RaycastAll(rRayStart, rRayDirection, rDistance);
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static RaycastHit[] SafeRaycastAllX(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, Transform rIgnore)
        {
            RaycastHit[] lHitArray = UnityEngine.Physics.RaycastAll(rRayStart, rRayDirection, rDistance);
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static bool SafeSphereCastX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static bool SafeSphereCastX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, Transform rIgnore, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static bool SafeSphereCastX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, int rLayerMask, Transform rIgnore, out RaycastHit rHitInfo)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static bool SafeSphereCastX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, Transform rIgnore, out RaycastHit rHitInfo, bool rRecast)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static bool SafeSphereCastX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, int rLayerMask, Transform rIgnore, out RaycastHit rHitInfo, bool rRecast)
        {
            int lHitCount = 0;
            float lDistanceOffset = 0f;
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static RaycastHit[] SafeSphereCastAllX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, Transform rIgnore)
        {
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static RaycastHit[] SafeSphereCastAllX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, int rLayerMask, Transform rIgnore)
        {
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static RaycastHit[] SafeSphereCastAllX(Vector3 rRayStart, Vector3 rRayDirection, float rRadius, float rDistance, List<Transform> rIgnore)
        {
            RaycastHit[] lHitArray = UnityEngine.Physics.SphereCastAll(rRayStart, rRadius, rRayDirection, rDistance);
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static Collider[] SafeOverlapSphereX(Vector3 rPosition, float rRadius, Transform rIgnore)
        {
            // This causes 28 B of GC.
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static Collider[] SafeOverlapSphereX(Vector3 rRayStart, float rRadius, int rLayerMask, Transform rIgnore)
        {
            // This causes 28 B of GC.
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static Collider[] SafeOverlapSphereX(Vector3 rRayStart, float rRadius, List<Transform> rIgnore)
        {
            // This causes 28 B of GC.
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public static Collider[] SafeOverlapSphereX(Vector3 rRayStart, float rRadius, int rLayerMask, List<Transform> rIgnore)
        {
            // This causes 28 B of GC.
            Collider[] lHitArray = UnityEngine.Physics.OverlapSphere(rRayStart, rRadius, rLayerMask);
